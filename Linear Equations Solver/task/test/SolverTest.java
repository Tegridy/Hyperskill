...
import static org.hyperskill.hstest.v4.common.Utils.readFile;
        ...
        return List.of(
            new TestCase<TestClue>()
                .setAttach(new TestClue(
                    ...
                    "out.txt",
                    new Double[]{1d, 2d, 3d}))
                .addArgument(new String[]{"-in", "in.txt", "-out", "out.txt"})
                .addFile("in.txt",
                "3\n" +
                    "1 1 2 9\n" +
                    "2 4 -3 1\n" +
            ...
            new TestCase<TestClue>()
                .setAttach(new TestClue(
                    ...
                    "out.txt",
                    new Double[]{1d, 1d}))
                .addArgument(new String[]{"-in", "input.txt", "-out", "out.txt"})
                .addFile("input.txt",
                "2\n" +
                    "1 0 1\n" +
                    "0 1 1"),
            ...
            new TestCase<TestClue>()
                .setAttach(new TestClue(
                    ...
                    "output.txt",
                    new Double[]{1d, 1d}))
                .addArgument(new String[]{"-in", "in.txt", "-out", "output.txt"})
                .addFile("in.txt",
                "2\n" +
                    "1 0 1\n" +
                    "0 1 1"),
